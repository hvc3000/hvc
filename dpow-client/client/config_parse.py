...
class DpowClientConfig(object):
    ...
    def __init__(self):
        ...
        parser.add_argument('--server', type=str, default='mqtt://client:client@dpow.nanocenter.org:1883', help="MQTT broker URI")
        parser.add_argument('--worker_uri', type=str, default='127.0.0.1:8000', help='URI of work server listening for RPC calls.')
